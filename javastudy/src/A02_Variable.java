	...
	public static void main(String[] args) {
		...
		/*
		 	# 변수 (Variable)
		 		...
		 		- ""나 ''가 ㅇ없는 모든 문자열 또는 문자는 변수다
		 		- 같은 이름의 변수는 다시 선언할 수 없다
		 		
		 	# 변수의 선언 (declare, declaration)
		 	
		 		-새로운 변수를 생성함과 동시에 '이름' 을 붙이는 작업
		...
		*/
		...
		int a;
		int apple; //< 변수란..... 파일명 같은건가..? 엑셀의 이름값 같은...(맞다!!! 맞음!!)
		
		// 원래 알고 있던 =의 의미 : 두 값이 서로 같다
		// 프로그래밍 언어에서  =의 의믜 : 왼쪽의 변수에 오른쪽의 값을 넣어라 (값을 대입)
		a = 5000;
		apple = a + 50;
		...
		//값이 한 번도 대입된 저깅 없는 변수는 사용할 수 없다.
		// (초기화되지 않은 변수)

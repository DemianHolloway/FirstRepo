...
public class D07_HashMap {
	...
	public static void main(String[] args) {
		...
		// 연습문제: "홍길동" 에 저장되어 있는 수자를 3000 증가시켜 보세요
		...
		person.put("싫어하는 것", new String[] {"하이킹", "캠핑", "5인이상 집합 모임"});
		person.put("싫어하는 것", new HashSet<>());
		
		
		// 연습문제: "싫어하는 것"에 데이터를 추가해보세요
		HashSet<String> hate = ((HashSet)person.get("싫어하는 것"));
		...
		System.out.println(((String[]) person.get("싫어하는 것"))[2]);
		System.out.println(((String[]) person.get("싫어하는 것"))[2]);
		...
		for (String key : person.keySet()) {
			...
			// A instanceof B : A가 B의 인스턴스인지를 판별한다. 업캐스팅 상대에서도 판별된다

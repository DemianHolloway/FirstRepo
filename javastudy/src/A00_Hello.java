	...
	*/
	...
	public static void main(String[] args) {
		...
		/*
		 	...
		 	- 우리가 만든 소스 코드(.java)의 결과물(.class)은 bin 폴덜에 저장되어 있다
		...
		*/
		...
		/*
		 	...
		 	2. ''사이에 적는 것 : 문자, 문자 단 하나만 쓸 수 있는 데이터 타입

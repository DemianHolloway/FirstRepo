...
public class D02_HashSet {
	...
	/*
	 	...
	 	- 같은 값을 넣엇을 때는 항상 일정한 값이 나와야 한다
	 	- 유사한 값을 넣었을 때 예측하기 힘ㅁ든 전혀 다른 값이 나온다
...
*/		
		...
		// contaiansAll(Collection) : 전달한 컬렉션이 모두 포함되어 있는지를 검사
		...
		// addAll(Clooection) : 전달한 컬렉션의 내용을 모두 추가
		// - 새로 추가된 것이 있으면 true (추가 성공 여부를 반환)
		...
		// # retainAll(Collection) : 전달한 콜렉션과 일치하는 내용만 남긴다
		// - 변한 것이 있다며 true 업스염 false

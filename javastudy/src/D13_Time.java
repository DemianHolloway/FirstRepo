...
public class D13_Time {
	...
	/*
	 	...
	 	- java.time 패키지의 클래스들은 시간으 ㄹ계산한 뒤 새로운 인스턴스를 반환한다
	 	  원본 인스턴스는 그대로 유지한다
	 	  
	 	  - LocalDate, LocalTime, LocalTime이 있다
	 */
	
	public static void main(String[] args) {
		
		// 1. now(): 지금 시가느이 인스턴스르 생성하는 메서드
		
		// LocalDate: 날짜만 저장하기 위한 클래스
		LocalDate today = LocalDate.now();
		System.out.println(today);
		
		// LocalTime : 시가만 저장하기 위한 클래스
		...
		LocalTime promise = LocalTime.of(17, 8, 0);
		...
		System.out.println("2021년 어린이날이 2020년 크리스마스보다 앞 인가요?"

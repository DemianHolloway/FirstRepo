...
public class D08_String {
	...
	public static void main(String[] args) {
		...
		// substring(start, end) : start부터 end 미만까지 문자열을 잘라서 반환
		...
		// byre[]로 나뉠 때와 같은 인코딩 타입을 사용해야 한다
		try {
		...
		System.out.println("이건" + str1.equals(str2));
		...
		System.out.println("이건" + str1.equals(str2));
		System.out.println("이건" + str3.trim());
		...
		// equalsIgnoreCade() : 대소문자 상관없는 equals()
		str1 = "Hello Java";
		str2 = "hello JAVA";
		...
		//getChars(start, end, 담을 곳, 담을 곳 시작지점) : char[]에 문자열의 원하는 부분을 담을 수 있다

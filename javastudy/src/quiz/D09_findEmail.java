...
public class D09_findEmail {
	...
	public static void main(String[] args) {
		...
		// 다음 문자열에 이메일만 골라서 Arraylist에 차곡차곡 정리한 후 한번씩 출력해보기
		// 제대로된 이메일이 몇개인지도 세보기
		...
		String email_01 = "abcdefghijk.com"; // 테스트 할 이메일
		String email_02 = "ab12efg@hijk.co.kr"; // 테스트 할 이메일
		String email_03 = "e_am5le@hijk.com"; // 테스트 할 이메일

		String emailRegex = "^[_a-zA-Z0-9-\\.]+@[\\.a-zA-Z0-9-]+\\.[a-zA-Z]+$";
	
		System.out.println("이메일 판별: " + email_01.matches(emailRegex));
		System.out.println("이메일 판별: " + email_02.matches(emailRegex));
		System.out.println("이메일 판별: " + email_03.matches(emailRegex));
